...
import barchart from '../../../img/cardusage_barchart.PNG';
import './card_usage.scss'
        ...
        <MainLayout>
            ...
            <div class="row">
                ...
                <form className="sam_card_usage_form1">
                    ...
                    <img src={barchart} className="sam_cardusage_barchart"></img>
                    <p className="sam_cardusagep-1">No record is found for <br />this period</p>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h4 className="sam_cardusagestatisticsh4">Usage Statistics</h4>
                    <div className="card sam_card_usage2">
                        <div class="card-body">
