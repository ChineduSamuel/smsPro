        ...
        <div className="choose_template  ">
          ...
          <div className="template-card ">
            <div className="ml-4 d-flex justify-content align-items-center">
              <FormSelect                 label_class="label-light"
 title="Select Template" className="mr-5 select-normal" placeholder="Select"  />
              <button className="btn-template btn-template-text ml-5 mt-2" onClick={phaseTwo}>
        ...
        {activeIndex === 1 &&
          ...
          <div className="template-card">
           ...
           <div className="form-area mt-5">
             <FormInput label_class="label-normal" title ="Template Title" placeholder="My Promo Soap" className="input-normal" />
             <FormSelect label_class="label-normal" title="Category" className="select-normal-long" />
             <FormText label_class="label-normal" title="From"  placeholder ="type your message here"  />
