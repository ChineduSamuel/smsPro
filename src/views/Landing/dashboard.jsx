      ...
      <div className="Dashboard-page ">
        ...
        >
          ...
          <p className="paragraph">
            Hi Lekan, Welcome to your PROJECT SMS Dashbaord, You have been given
            a free wallet fund of N50(41.22 Units). Click here to get familiar
            with the service offers and start sending messages to your customers
            now.
          </p>
          <button
            type="button"
        ...
        <div className="row">
          <div className="col-1-of-4">
            <div className="inner-content">
              ...
              <div className="">
                <p>
                  <span className="heading-primary-naira">&#x20A6;50.00</span>{' '}
                  <small className="heading-primary-units">41.22 units</small>
                </p>
                <p className="img-right">
                  <img src={wallet} alt="" />
                </p>
              </div>
            </div>
          ...
          <div className="col-1-of-4">
            <div className="inner-content">
              ...
              <div className="">
                <p>
                  <span className="heading-primary-naira">&#x20A6;00</span>{' '}
                  <small className="heading-primary-units">41.22 units</small>
                </p>
                <p className="img-right">
                  <img src={refferal_earnings} alt="" />
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-1-of-4">
            <div className="inner-content">
              ...
              <div className="">
                <p>
                  <span className="heading-primary-naira">&#x20A6;50</span>{' '}
                  <small className="heading-primary-units">41.22 units</small>
                </p>
                <p className="img-right">
                  <img src={wallet} alt="" />
          ...
          <div className="col-1-of-4">
            <div className="inner-content">
              ...
              <div className="">
                <p>
                  <span className="heading-primary-naira">2</span>{' '}
                  <small className="heading-primary-units">41.22 units</small>
                </p>
                <p className="img-right">
                  <img src={campaigns_made} alt="" />
                </p>
              </div>
            </div>
          </div>
          <div className="col-1-of-4">
            <div className="inner-content">
              ...
              <div className="">
                <p>
                  <span className="heading-primary-naira">82</span>{' '}
                  <small className="heading-primary-units">41.22 units</small>
                </p>
                <p className="img-right">
          ...
          <div className="col-1-of-4">
            <div className="inner-content">
              ...
              <div className="">
                <p>
                  <span className="heading-primary-naira">&#x20A6;16</span>{' '}
                  <small className="heading-primary-units">41.22 units</small>
                </p>
                <p className="img-right">
                  <img src={total_failed} alt="" />
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-1-of-4">
            <div className="inner-content">
              ...
              <div className="">
                <p>
                  <span className="heading-primary-naira">&#x20A6;80</span>{' '}
                  <small className="heading-primary-units">41.22 units</small>
                </p>
                <p className="img-right">
          ...
          <div className="row">
            <div className="col-md-8">
              <div className="graph-sheet">
                <p className="graph-header pt-4">So far</p>
            ...
            <div className="col-md-4 summary-board">
              <div className="items-border">
                <div className="pt-4 head">Total Sent</div>
                <div className="sub">449</div>
              </div>
              <div className="items-border">
                <div className="pt-4 head">Total Sent</div>
                <div className="sub">339</div>
              </div>
              <div className="items-border">
                <div className="pt-4 head">Total Sent</div>
                <div className="sub">36</div>
              </div>
              <div className="items-border">
                <div className="pt-4 head">Total Sent</div>
                <div className="sub">36s</div>
              </div>
              <div className="items-border">
                <div className="pt-4 head">Total Sent</div>
                <div className="sub">96%</div>
              </div>
            </div>
          </div>
        </div>
