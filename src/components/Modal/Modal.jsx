    ...
    >
      <div className="my_modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="my_modal-header">
          <div className="d-flex justify-content-end align-items-top" onClick={props.onClose} style={{cursor: 'pointer'}}>&times;</div>
          <h4 className="my_modal-title pt-5">{props.title}</h4>
        </div>
